...
const navItems = [
  ...
  { to: '/project/1', icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5', i18n: 'nav.project' },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 flex flex-col z-40 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-colors duration-300">
      ...
      <div className="px-3 pb-4 pt-3 border-t border-slate-200 dark:border-slate-800 space-y-2">
        ...
        {/* User */}
        <div className="flex items-center gap-2.5 px-2 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800/60 cursor-pointer transition-colors">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 truncate">alex@agence.fr</p>
          </div>
          <svg className="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9l-3.75 3.75L8.25 9" />
          </svg>
        </div>
      </div>
    </aside>
