          ...
          <div className="space-y-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 text-xs text-slate-400 bg-white dark:bg-slate-900">
                  {t('login.or')}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" className="input-field" placeholder="Alex" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
                  {t('login.lastName')}
                </label>
                <input type="text" className="input-field" placeholder="Chen" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
